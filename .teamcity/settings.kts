    ...
    steps {
        ...
        script {
            ...
            scriptContent = """
                ...
                curl -H "Authorization: token %github.publishing_token%" -XPOST -i -T artifactory-artifact-storage-%teamcity.build.branch%.zip "${'$'}{upload_url}?name=artifactory-artifact-storage-%teamcity.build.branch%.zip"
            """.trimIndent()
        }
    }
